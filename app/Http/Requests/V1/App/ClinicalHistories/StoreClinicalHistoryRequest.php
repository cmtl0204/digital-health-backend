...
class StoreClinicalHistoryRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'metabolicAge' => ['nullable','numeric','min:0', 'max:100'],
            'neckCircumference' => ['nullable','numeric','min:20', 'max:90'],
            'percentageBodyFat' => ['nullable','numeric','min:0', 'max:90'],
    ...
    public function attributes()
    {
        return [
            ...
            'neckCircumference' => 'circunferencia de cuello',
            'percentageBodyFat' => 'masa muscular',
